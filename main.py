...
if len(sys.argv) == 2 and "resurrect" not in sys.argv[1]:
	...
	sys.stderr.write("Usage: cat <stream> | python main.py <delta> [--resurrect=<err_file>]\n\n")
	sys.stderr.write("  --resurrect: Recover previous instance by providing an stderr output \
	previous instance.\n\n")
	sys.exit(1)
